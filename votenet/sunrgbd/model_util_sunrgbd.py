...
class SunrgbdDatasetConfig(object):
    def __init__(self):
        ...
        self.type2class={'wall':0, 'floor':1, 'ceiling':2, 'other':3}
        self.class2type = {self.type2class[t]:t for t in self.type2class}
        self.type2onehotclass={'bed':0, 'floor':1, 'ceiling':2, 'other':3}
        # very much a placeholder 
        self.type_mean_size = {'wall': np.array([2.305,1.305,0.315]),
                            'floor': np.array([1.405,.053,1.257]),
                            'ceiling': np.array([1.405,0.053,1.257]),
                            'other': np.array([0.752,0.752,0.752])}
